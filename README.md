...
**Build 7.8.1 is a more flexible session builder.** Choose Random, Not in my week, Needs focus, or My preferences, then keep a broad training focus or narrow the session to a muscle group and specific muscle. Picks respect saved equipment and movement limits, explain their selection, and disclose missing or partial workout history. Review the session before adding it to the saved week. See the [7.8.1 release guide](docs/release-7.8.1.md) for scope and validation status.
