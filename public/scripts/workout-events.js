...
(function(root,factory){
  ...
  function bind({$,state,workout:W,number,signal,actions,windowLike=globalThis.window,documentLike=globalThis.document,locationLike=globalThis.location,historyLike=globalThis.history,confirmImpl=globalThis.confirm}){
    ...
    $("checkInForm").addEventListener("submit",event=>{event.preventDefault();void actions.saveCheckIn();});$("acceptAdaptation").addEventListener("click",()=>void resolveAdaptation("accept"));$("dismissAdaptation").addEventListener("click",()=>void resolveAdaptation("dismiss"));
