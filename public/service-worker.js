...
const PRECACHE_URLS=[
  ...
  "/workout.css?v=7.1.2",
  "/workout.js?v=7.1.2",
  "/workout-core.js?v=7.1.2",
  "/onboarding.css?v=7.1.2",
  "/product-nav.css?v=7.1.2",
  "/onboarding.js?v=7.1.2",
  "/onboarding-core.js?v=7.1.2",
  "/install.css?v=7.1.2",
  "/install.js?v=7.1.2",
  "/offline.js?v=7.1.2",
  "/site-info.css?v=7.1.2",
  "/pricing.js?v=7.1.2",
  "/contact.js?v=7.1.2",
  "/pwa.js?v=7.1.2",
  "/styles.css?v=7.1.2",
  ...
  "/account.css?v=7.1.2",
  "/account.js?v=7.1.2",
  "/account-recovery.js?v=7.1.2",
  "/planner.css?v=7.1.2",
  "/planner.js?v=7.1.2",
  "/discover.css?v=7.1.2",
  "/discovery-core.js?v=7.1.2",
  "/monthly-plan-core.js?v=7.1.2",
  "/discover.js?v=7.1.2",
  "/exercises.json?v=7.1.2",
