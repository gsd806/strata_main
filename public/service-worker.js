...
const PRECACHE_URLS=[
  ...
  "/workout.css?v=7.1.3",
  "/workout.js?v=7.1.3",
  "/workout-core.js?v=7.1.3",
  "/onboarding.css?v=7.1.3",
  "/product-nav.css?v=7.1.3",
  "/onboarding.js?v=7.1.3",
  "/onboarding-core.js?v=7.1.3",
  "/install.css?v=7.1.3",
  "/install.js?v=7.1.3",
  "/offline.js?v=7.1.3",
  "/site-info.css?v=7.1.3",
  "/pricing.js?v=7.1.3",
  "/contact.js?v=7.1.3",
  "/pwa.js?v=7.1.3",
  "/styles.css?v=7.1.3",
  ...
  "/account.css?v=7.1.3",
  "/account.js?v=7.1.3",
  "/account-recovery.js?v=7.1.3",
  "/planner.css?v=7.1.3",
  "/planner.js?v=7.1.3",
  "/discover.css?v=7.1.3",
  "/discovery-core.js?v=7.1.3",
  "/monthly-plan-core.js?v=7.1.3",
  "/discover.js?v=7.1.3",
  "/exercises.json?v=7.1.3",
