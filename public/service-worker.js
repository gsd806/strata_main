...
const PRECACHE_URLS=[
  "/experience.css?v=7.8.6",
  "/fonts.css?v=7.8.6",
  "/product-signals.css?v=7.8.6",
  "/product-signals.js?v=7.8.6",
  "/motion.js?v=7.8.6",
  "/offline.html",
  ...
  "/workout.css?v=7.8.6",
  "/workout.js?v=7.8.6",
  "/workout-core.js?v=7.8.6",
  "/workout-state.js?v=7.8.6",
  "/workout-api.js?v=7.8.6",
  "/workout-calendar.js?v=7.8.6",
  "/workout-progression.js?v=7.8.6",
  "/workout-render.js?v=7.8.6",
  "/workout-context.js?v=7.8.6",
  "/workout-guidance.js?v=7.8.6",
  "/workout-history.js?v=7.8.6",
  "/workout-events.js?v=7.8.6",
  "/workout-offline.css?v=7.8.6",
  "/workout-offline.js?v=7.8.6",
  "/onboarding.css?v=7.8.6",
  "/product-nav.css?v=7.8.6",
  "/onboarding.js?v=7.8.6",
  "/onboarding-core.js?v=7.8.6",
  "/activation-core.js?v=7.8.6",
  "/activation-handoff.js?v=7.8.6",
  "/activation-home.js?v=7.8.6",
  "/plan-insights-core.js?v=7.8.6",
  "/install.css?v=7.8.6",
  "/install.js?v=7.8.6",
  "/offline.js?v=7.8.6",
  "/site-info.css?v=7.8.6",
  "/pricing-logic.js?v=7.8.6",
  "/pricing-state.js?v=7.8.6",
  "/pricing-api.js?v=7.8.6",
  "/pricing-render.js?v=7.8.6",
  "/pricing-events.js?v=7.8.6",
  "/pricing.js?v=7.8.6",
  "/contact.js?v=7.8.6",
  "/pwa.js?v=7.8.6",
  "/styles.css?v=7.8.6",
  "/home-logic.js?v=7.8.6",
  "/home-state.js?v=7.8.6",
  "/home-api.js?v=7.8.6",
  "/home-render.js?v=7.8.6",
  "/home-events.js?v=7.8.6",
  "/app.js?v=7.8.6",
  "/account.css?v=7.8.6",
  "/account-logic.js?v=7.8.6",
  "/account-state.js?v=7.8.6",
  "/account-api.js?v=7.8.6",
  "/account-render.js?v=7.8.6",
  "/account-events.js?v=7.8.6",
  "/account.js?v=7.8.6",
  "/account-recovery.js?v=7.8.6",
  "/planner.css?v=7.8.6",
  "/planner-logic.js?v=7.8.6",
  "/planner-state.js?v=7.8.6",
  "/planner-api.js?v=7.8.6",
  "/planner-render.js?v=7.8.6",
  "/planner-conflicts.js?v=7.8.6",
  "/planner-templates.js?v=7.8.6",
  "/planner-sharing.js?v=7.8.6",
  "/planner-activation.js?v=7.8.6",
  "/planner-events.js?v=7.8.6",
  "/planner.js?v=7.8.6",
  "/discover.css?v=7.8.6",
  "/session-selection-core.js?v=7.8.6",
  "/discovery-core.js?v=7.8.6",
  "/preview-core.js?v=7.8.6",
  "/monthly-plan-core.js?v=7.8.6",
  "/discover-state.js?v=7.8.6",
  "/discover-api.js?v=7.8.6",
  "/discover-navigation.js?v=7.8.6",
  "/discover-progress.js?v=7.8.6",
  "/discover-render.js?v=7.8.6",
  "/discover-catalog.js?v=7.8.6",
  "/discover-detail.js?v=7.8.6",
  "/discover-community.js?v=7.8.6",
  "/discover-session.js?v=7.8.6",
  "/discover-sharing.js?v=7.8.6",
  "/discover-events.js?v=7.8.6",
  "/discover.js?v=7.8.6",
  "/training-block-core.js?v=7.8.6",
  "/exercises.json?v=7.8.6",
