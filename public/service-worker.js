...
const PRECACHE_URLS=[
  ...
  "/account.css?v=7.0.0",
  "/account.js?v=7.0.0",
  "/account-recovery.js?v=7.0.0",
  "/planner.css?v=7.0.0",
  "/planner.js?v=7.0.0",
  "/discover.css?v=7.0.0",
  "/discovery-core.js?v=7.0.0",
  "/monthly-plan-core.js?v=7.0.0",
  "/discover.js?v=7.0.0",
  "/exercises.json?v=7.0.0",
