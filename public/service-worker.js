...
const PRECACHE_URLS=[
  "/experience.css?v=7.8.7",
  "/fonts.css?v=7.8.7",
  "/product-signals.css?v=7.8.7",
  "/product-signals.js?v=7.8.7",
  "/motion.js?v=7.8.7",
  "/offline.html",
  ...
  "/workout.css?v=7.8.7",
  "/workout.js?v=7.8.7",
  "/workout-core.js?v=7.8.7",
  "/workout-state.js?v=7.8.7",
  "/workout-api.js?v=7.8.7",
  "/workout-calendar.js?v=7.8.7",
  "/workout-progression.js?v=7.8.7",
  "/workout-render.js?v=7.8.7",
  "/workout-context.js?v=7.8.7",
  "/workout-guidance.js?v=7.8.7",
  "/workout-history.js?v=7.8.7",
  "/workout-events.js?v=7.8.7",
  "/workout-offline.css?v=7.8.7",
  "/workout-offline.js?v=7.8.7",
  "/onboarding.css?v=7.8.7",
  "/product-nav.css?v=7.8.7",
  "/onboarding.js?v=7.8.7",
  "/onboarding-core.js?v=7.8.7",
  "/activation-core.js?v=7.8.7",
  "/activation-handoff.js?v=7.8.7",
  "/activation-home.js?v=7.8.7",
  "/plan-insights-core.js?v=7.8.7",
  "/install.css?v=7.8.7",
  "/install.js?v=7.8.7",
  "/offline.js?v=7.8.7",
  "/site-info.css?v=7.8.7",
  "/pricing-logic.js?v=7.8.7",
  "/pricing-state.js?v=7.8.7",
  "/pricing-api.js?v=7.8.7",
  "/pricing-render.js?v=7.8.7",
  "/pricing-events.js?v=7.8.7",
  "/pricing.js?v=7.8.7",
  "/contact.js?v=7.8.7",
  "/pwa.js?v=7.8.7",
  "/styles.css?v=7.8.7",
  "/home-logic.js?v=7.8.7",
  "/home-state.js?v=7.8.7",
  "/home-api.js?v=7.8.7",
  "/home-render.js?v=7.8.7",
  "/home-events.js?v=7.8.7",
  "/app.js?v=7.8.7",
  "/account.css?v=7.8.7",
  "/account-logic.js?v=7.8.7",
  "/account-state.js?v=7.8.7",
  "/account-api.js?v=7.8.7",
  "/account-render.js?v=7.8.7",
  "/account-events.js?v=7.8.7",
  "/account.js?v=7.8.7",
  "/account-recovery.js?v=7.8.7",
  "/planner.css?v=7.8.7",
  "/planner-logic.js?v=7.8.7",
  "/planner-state.js?v=7.8.7",
  "/planner-api.js?v=7.8.7",
  "/planner-render.js?v=7.8.7",
  "/planner-conflicts.js?v=7.8.7",
  "/planner-templates.js?v=7.8.7",
  "/planner-sharing.js?v=7.8.7",
  "/planner-activation.js?v=7.8.7",
  "/planner-events.js?v=7.8.7",
  "/planner.js?v=7.8.7",
  "/discover.css?v=7.8.7",
  "/session-selection-core.js?v=7.8.7",
  "/discovery-core.js?v=7.8.7",
  "/preview-core.js?v=7.8.7",
  "/monthly-plan-core.js?v=7.8.7",
  "/personal-training-ui-core.js?v=7.8.7",
  "/discover-state.js?v=7.8.7",
  "/discover-api.js?v=7.8.7",
  "/discover-navigation.js?v=7.8.7",
  "/discover-progress.js?v=7.8.7",
  "/discover-render.js?v=7.8.7",
  "/discover-coaching-render.js?v=7.8.7",
  "/discover-catalog.js?v=7.8.7",
  "/discover-detail.js?v=7.8.7",
  "/discover-community.js?v=7.8.7",
  "/discover-session.js?v=7.8.7",
  "/discover-sharing.js?v=7.8.7",
  "/discover-events.js?v=7.8.7",
  "/discover-coaching.js?v=7.8.7",
  "/discover.js?v=7.8.7",
  "/training-block-core.js?v=7.8.7",
  "/exercises.json?v=7.8.7",
