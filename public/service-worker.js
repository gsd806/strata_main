...
const PRECACHE_URLS=[
  "/experience.css?v=7.8.5",
  "/fonts.css?v=7.8.5",
  "/product-signals.css?v=7.8.5",
  "/product-signals.js?v=7.8.5",
  "/motion.js?v=7.8.5",
  "/offline.html",
  ...
  "/workout.css?v=7.8.5",
  "/workout.js?v=7.8.5",
  "/workout-core.js?v=7.8.5",
  "/workout-state.js?v=7.8.5",
  "/workout-api.js?v=7.8.5",
  "/workout-calendar.js?v=7.8.5",
  "/workout-progression.js?v=7.8.5",
  "/workout-render.js?v=7.8.5",
  "/workout-context.js?v=7.8.5",
  "/workout-guidance.js?v=7.8.5",
  "/workout-history.js?v=7.8.5",
  "/workout-events.js?v=7.8.5",
  "/workout-offline.css?v=7.8.5",
  "/workout-offline.js?v=7.8.5",
  "/onboarding.css?v=7.8.5",
  "/product-nav.css?v=7.8.5",
  "/onboarding.js?v=7.8.5",
  "/onboarding-core.js?v=7.8.5",
  "/activation-core.js?v=7.8.5",
  "/activation-handoff.js?v=7.8.5",
  "/activation-home.js?v=7.8.5",
  "/plan-insights-core.js?v=7.8.5",
  "/install.css?v=7.8.5",
  "/install.js?v=7.8.5",
  "/offline.js?v=7.8.5",
  "/site-info.css?v=7.8.5",
  "/pricing-logic.js?v=7.8.5",
  "/pricing-state.js?v=7.8.5",
  "/pricing-api.js?v=7.8.5",
  "/pricing-render.js?v=7.8.5",
  "/pricing-events.js?v=7.8.5",
  "/pricing.js?v=7.8.5",
  "/contact.js?v=7.8.5",
  "/pwa.js?v=7.8.5",
  "/styles.css?v=7.8.5",
  "/home-logic.js?v=7.8.5",
  "/home-state.js?v=7.8.5",
  "/home-api.js?v=7.8.5",
  "/home-render.js?v=7.8.5",
  "/home-events.js?v=7.8.5",
  "/app.js?v=7.8.5",
  "/account.css?v=7.8.5",
  "/account-logic.js?v=7.8.5",
  "/account-state.js?v=7.8.5",
  "/account-api.js?v=7.8.5",
  "/account-render.js?v=7.8.5",
  "/account-events.js?v=7.8.5",
  "/account.js?v=7.8.5",
  "/account-recovery.js?v=7.8.5",
  "/planner.css?v=7.8.5",
  "/planner-logic.js?v=7.8.5",
  "/planner-state.js?v=7.8.5",
  "/planner-api.js?v=7.8.5",
  "/planner-render.js?v=7.8.5",
  "/planner-conflicts.js?v=7.8.5",
  "/planner-templates.js?v=7.8.5",
  "/planner-sharing.js?v=7.8.5",
  "/planner-activation.js?v=7.8.5",
  "/planner-events.js?v=7.8.5",
  "/planner.js?v=7.8.5",
  "/discover.css?v=7.8.5",
  "/session-selection-core.js?v=7.8.5",
  "/discovery-core.js?v=7.8.5",
  "/preview-core.js?v=7.8.5",
  "/monthly-plan-core.js?v=7.8.5",
  "/discover-state.js?v=7.8.5",
  "/discover-api.js?v=7.8.5",
  "/discover-navigation.js?v=7.8.5",
  "/discover-progress.js?v=7.8.5",
  "/discover-render.js?v=7.8.5",
  "/discover-catalog.js?v=7.8.5",
  "/discover-detail.js?v=7.8.5",
  "/discover-community.js?v=7.8.5",
  "/discover-session.js?v=7.8.5",
  "/discover-sharing.js?v=7.8.5",
  "/discover-events.js?v=7.8.5",
  "/discover.js?v=7.8.5",
  "/training-block-core.js?v=7.8.5",
  "/exercises.json?v=7.8.5",
