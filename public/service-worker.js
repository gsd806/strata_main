...
const PRECACHE_URLS=[
  "/experience.css?v=7.8.0",
  "/fonts.css?v=7.8.0",
  "/product-signals.css?v=7.8.0",
  "/product-signals.js?v=7.8.0",
  "/motion.js?v=7.8.0",
  "/offline.html",
  ...
  "/workout.css?v=7.8.0",
  "/workout.js?v=7.8.0",
  "/workout-core.js?v=7.8.0",
  "/workout-state.js?v=7.8.0",
  "/workout-api.js?v=7.8.0",
  "/workout-calendar.js?v=7.8.0",
  "/workout-render.js?v=7.8.0",
  "/workout-guidance.js?v=7.8.0",
  "/workout-history.js?v=7.8.0",
  "/workout-events.js?v=7.8.0",
  "/workout-offline.css?v=7.8.0",
  "/workout-offline.js?v=7.8.0",
  "/onboarding.css?v=7.8.0",
  "/product-nav.css?v=7.8.0",
  "/onboarding.js?v=7.8.0",
  "/onboarding-core.js?v=7.8.0",
  "/activation-core.js?v=7.8.0",
  "/activation-handoff.js?v=7.8.0",
  "/activation-home.js?v=7.8.0",
  "/plan-insights-core.js?v=7.8.0",
  "/install.css?v=7.8.0",
  "/install.js?v=7.8.0",
  "/offline.js?v=7.8.0",
  "/site-info.css?v=7.8.0",
  "/pricing-logic.js?v=7.8.0",
  "/pricing-state.js?v=7.8.0",
  "/pricing-api.js?v=7.8.0",
  "/pricing-render.js?v=7.8.0",
  "/pricing-events.js?v=7.8.0",
  "/pricing.js?v=7.8.0",
  "/contact.js?v=7.8.0",
  "/pwa.js?v=7.8.0",
  "/styles.css?v=7.8.0",
  "/home-logic.js?v=7.8.0",
  "/home-state.js?v=7.8.0",
  "/home-api.js?v=7.8.0",
  "/home-render.js?v=7.8.0",
  "/home-events.js?v=7.8.0",
  "/app.js?v=7.8.0",
  "/account.css?v=7.8.0",
  "/account-logic.js?v=7.8.0",
  "/account-state.js?v=7.8.0",
  "/account-api.js?v=7.8.0",
  "/account-render.js?v=7.8.0",
  "/account-events.js?v=7.8.0",
  "/account.js?v=7.8.0",
  "/account-recovery.js?v=7.8.0",
  "/planner.css?v=7.8.0",
  "/planner-logic.js?v=7.8.0",
  "/planner-state.js?v=7.8.0",
  "/planner-api.js?v=7.8.0",
  "/planner-render.js?v=7.8.0",
  "/planner-conflicts.js?v=7.8.0",
  "/planner-templates.js?v=7.8.0",
  "/planner-sharing.js?v=7.8.0",
  "/planner-activation.js?v=7.8.0",
  "/planner-events.js?v=7.8.0",
  "/planner.js?v=7.8.0",
  "/discover.css?v=7.8.0",
  "/discovery-core.js?v=7.8.0",
  "/preview-core.js?v=7.8.0",
  "/monthly-plan-core.js?v=7.8.0",
  "/discover-state.js?v=7.8.0",
  "/discover-api.js?v=7.8.0",
  "/discover-navigation.js?v=7.8.0",
  "/discover-progress.js?v=7.8.0",
  "/discover-render.js?v=7.8.0",
  "/discover-catalog.js?v=7.8.0",
  "/discover-detail.js?v=7.8.0",
  "/discover-community.js?v=7.8.0",
  "/discover-session.js?v=7.8.0",
  "/discover-sharing.js?v=7.8.0",
  "/discover-events.js?v=7.8.0",
  "/discover.js?v=7.8.0",
  "/training-block-core.js?v=7.8.0",
  "/exercises.json?v=7.8.0",
