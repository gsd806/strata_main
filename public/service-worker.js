...
const PRECACHE_URLS=[
  "/experience.css?v=7.7.1",
  "/fonts.css?v=7.7.1",
  "/product-signals.css?v=7.7.1",
  "/product-signals.js?v=7.7.1",
  "/motion.js?v=7.7.1",
  "/offline.html",
  ...
  "/workout.css?v=7.7.1",
  "/workout.js?v=7.7.1",
  "/workout-core.js?v=7.7.1",
  "/workout-offline.css?v=7.7.1",
  "/workout-offline.js?v=7.7.1",
  "/onboarding.css?v=7.7.1",
  "/product-nav.css?v=7.7.1",
  "/onboarding.js?v=7.7.1",
  "/onboarding-core.js?v=7.7.1",
  "/activation-core.js?v=7.7.1",
  "/activation-handoff.js?v=7.7.1",
  "/activation-home.js?v=7.7.1",
  "/plan-insights-core.js?v=7.7.1",
  "/install.css?v=7.7.1",
  "/install.js?v=7.7.1",
  "/offline.js?v=7.7.1",
  "/site-info.css?v=7.7.1",
  "/pricing.js?v=7.7.1",
  "/contact.js?v=7.7.1",
  "/pwa.js?v=7.7.1",
  "/styles.css?v=7.7.1",
  ...
  "/account.css?v=7.7.1",
  "/account.js?v=7.7.1",
  "/account-recovery.js?v=7.7.1",
  "/planner.css?v=7.7.1",
  "/planner.js?v=7.7.1",
  "/discover.css?v=7.7.1",
  "/discovery-core.js?v=7.7.1",
  "/preview-core.js?v=7.7.1",
  "/monthly-plan-core.js?v=7.7.1",
  "/discover.js?v=7.7.1",
  "/training-block-core.js?v=7.7.1",
  "/exercises.json?v=7.7.1",
