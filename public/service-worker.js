...
const PRECACHE_URLS=[
  "/experience.css?v=7.4.0",
  "/product-signals.css?v=7.4.0",
  "/product-signals.js?v=7.4.0",
  "/motion.js?v=7.4.0",
  "/offline.html",
  "/install.html",
  "/pricing.html",
  ...
  "/workout.css?v=7.4.0",
  "/workout.js?v=7.4.0",
  "/workout-core.js?v=7.4.0",
  "/onboarding.css?v=7.4.0",
  "/product-nav.css?v=7.4.0",
  "/onboarding.js?v=7.4.0",
  "/onboarding-core.js?v=7.4.0",
  "/install.css?v=7.4.0",
  "/install.js?v=7.4.0",
  "/offline.js?v=7.4.0",
  "/site-info.css?v=7.4.0",
  "/pricing.js?v=7.4.0",
  "/contact.js?v=7.4.0",
  "/pwa.js?v=7.4.0",
  "/styles.css?v=7.4.0",
  ...
  "/account.css?v=7.4.0",
  "/account.js?v=7.4.0",
  "/account-recovery.js?v=7.4.0",
  "/planner.css?v=7.4.0",
  "/planner.js?v=7.4.0",
  "/discover.css?v=7.4.0",
  "/discovery-core.js?v=7.4.0",
  "/preview-core.js?v=7.4.0",
  "/monthly-plan-core.js?v=7.4.0",
  "/discover.js?v=7.4.0",
  "/exercises.json?v=7.4.0",
