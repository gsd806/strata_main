...
const PRECACHE_URLS=[
  "/experience.css?v=7.8.2",
  "/fonts.css?v=7.8.2",
  "/product-signals.css?v=7.8.2",
  "/product-signals.js?v=7.8.2",
  "/motion.js?v=7.8.2",
  "/offline.html",
  ...
  "/workout.css?v=7.8.2",
  "/workout.js?v=7.8.2",
  "/workout-core.js?v=7.8.2",
  "/workout-state.js?v=7.8.2",
  "/workout-api.js?v=7.8.2",
  "/workout-calendar.js?v=7.8.2",
  "/workout-progression.js?v=7.8.2",
  "/workout-render.js?v=7.8.2",
  "/workout-guidance.js?v=7.8.2",
  "/workout-history.js?v=7.8.2",
  "/workout-events.js?v=7.8.2",
  "/workout-offline.css?v=7.8.2",
  "/workout-offline.js?v=7.8.2",
  "/onboarding.css?v=7.8.2",
  "/product-nav.css?v=7.8.2",
  "/onboarding.js?v=7.8.2",
  "/onboarding-core.js?v=7.8.2",
  "/activation-core.js?v=7.8.2",
  "/activation-handoff.js?v=7.8.2",
  "/activation-home.js?v=7.8.2",
  "/plan-insights-core.js?v=7.8.2",
  "/install.css?v=7.8.2",
  "/install.js?v=7.8.2",
  "/offline.js?v=7.8.2",
  "/site-info.css?v=7.8.2",
  "/pricing-logic.js?v=7.8.2",
  "/pricing-state.js?v=7.8.2",
  "/pricing-api.js?v=7.8.2",
  "/pricing-render.js?v=7.8.2",
  "/pricing-events.js?v=7.8.2",
  "/pricing.js?v=7.8.2",
  "/contact.js?v=7.8.2",
  "/pwa.js?v=7.8.2",
  "/styles.css?v=7.8.2",
  "/home-logic.js?v=7.8.2",
  "/home-state.js?v=7.8.2",
  "/home-api.js?v=7.8.2",
  "/home-render.js?v=7.8.2",
  "/home-events.js?v=7.8.2",
  "/app.js?v=7.8.2",
  "/account.css?v=7.8.2",
  "/account-logic.js?v=7.8.2",
  "/account-state.js?v=7.8.2",
  "/account-api.js?v=7.8.2",
  "/account-render.js?v=7.8.2",
  "/account-events.js?v=7.8.2",
  "/account.js?v=7.8.2",
  "/account-recovery.js?v=7.8.2",
  "/planner.css?v=7.8.2",
  "/planner-logic.js?v=7.8.2",
  "/planner-state.js?v=7.8.2",
  "/planner-api.js?v=7.8.2",
  "/planner-render.js?v=7.8.2",
  "/planner-conflicts.js?v=7.8.2",
  "/planner-templates.js?v=7.8.2",
  "/planner-sharing.js?v=7.8.2",
  "/planner-activation.js?v=7.8.2",
  "/planner-events.js?v=7.8.2",
  "/planner.js?v=7.8.2",
  "/discover.css?v=7.8.2",
  "/session-selection-core.js?v=7.8.2",
  "/discovery-core.js?v=7.8.2",
  "/preview-core.js?v=7.8.2",
  "/monthly-plan-core.js?v=7.8.2",
  "/discover-state.js?v=7.8.2",
  "/discover-api.js?v=7.8.2",
  "/discover-navigation.js?v=7.8.2",
  "/discover-progress.js?v=7.8.2",
  "/discover-render.js?v=7.8.2",
  "/discover-catalog.js?v=7.8.2",
  "/discover-detail.js?v=7.8.2",
  "/discover-community.js?v=7.8.2",
  "/discover-session.js?v=7.8.2",
  "/discover-sharing.js?v=7.8.2",
  "/discover-events.js?v=7.8.2",
  "/discover.js?v=7.8.2",
  "/training-block-core.js?v=7.8.2",
  "/exercises.json?v=7.8.2",
