...
test("keeps root, private server, and public browser files separated",()=>{
  for(const required of [
    "server.js","src/server.js","src/admin.js","src/auth.js","src/database.js","src/email.js","src/http.js","src/payments.js","src/plans.js","src/schema.js","src/store-contract.js","src/support.js",
  ...
  assert.deepEqual(readdirSync(SRC_ROOT).sort(),["admin.js","auth.js","data","database.js","email.js","http.js","payments.js","plans.js","schema.js","server.js","store-contract.js","support.js"]);
...
test("keeps credentials, databases, and private modules out of public",()=>{
  ...
  const forbiddenNames=new Set(["server.js","auth.js","database.js","email.js","http.js","payments.js","plans.js","schema.js","store-contract.js","support.js","discovery-data.json","render.yaml","package.json","package-lock.json"]);
